...
export type Post = {
  ...
  publishedAt?: string;
  tierAccess?: "startStrong" | "powerPulse" | "elevateElite";
  mainImage?: {
    asset?: {
      _ref: string;
      _type: "reference";
...
// Query: *[_type == "post" && tierAccess == $tier] | order(_createdAt desc) {    ...,    mainImage {      ...,      asset->    },    "comments": *[_type == "comment" && post._ref == ^._id] | order(createdAt desc)  }
